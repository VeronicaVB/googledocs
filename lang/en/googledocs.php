...
$string['sharedurl'] = 'File Shared URL';
$string['cron_task'] = 'Googledocs Cron Task';
$string['google_service_acc'] = 'Google Service Account';
$string['google_service_acc_desc'] = 'Service Account needed to work on cron task';
